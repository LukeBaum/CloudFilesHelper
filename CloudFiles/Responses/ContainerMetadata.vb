...
Namespace CloudFiles
    ...
    Public Class ContainerMetadata
        ...
        Private pHeaders As New List(Of X_Container_Meta_Header)

        Public Property Headers As List(Of X_Container_Meta_Header)
            Get
                Return Me.pHeaders
            End Get
            Set(value As List(Of X_Container_Meta_Header))
                pHeaders = value
            End Set
        End Property
    ...
    Public Class X_Container_Meta_Header
        ...
        Public ReadOnly Property Name As String
            Get
                Return "X-Container-Meta-" & Me.NameNotIncludingPrefix
            End Get
        End Property
